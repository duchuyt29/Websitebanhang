...
public class AccountController {
	...
	@GetMapping("/create")
	public String create(Model model, @ModelAttribute("account") AccountsModel account,
	...
	@PostMapping("/store")
	public String store(@Valid Model model, AccountsModel accountsModel,
			@ModelAttribute("account") AccountsModel account, BindingResult result) {
...
//		}
	...
	@GetMapping("/edit/{id}")
	public String edit(Model model, @PathVariable("id") Accounts accounts,
